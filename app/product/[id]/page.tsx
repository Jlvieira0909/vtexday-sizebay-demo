...
import SizeSelector from "../../../components/SizeSelector"; // Importação do novo componente
      ...
      <div className="bg-white rounded-3xl md:rounded-4xl shadow-sm border border-gray-100 overflow-hidden p-6 md:p-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16">
          ...
          <div className="flex flex-col space-y-6 md:space-y-8">
            ...
            <button className="BuyButton mt-6 md:mt-10 w-full bg-gray-950 text-white py-4 md:py-5 rounded-2xl font-extrabold text-base md:text-lg hover:bg-gray-900 transition-colors shadow-sm">
